        ...
        if (
            ...
            const { data: response } = axios.post(`https://api.woofics.com/api/form`, {
                ...
                .then((response) => {
                    ...
                    alert('GRACIAS POR TU TIEMPO. EN 48 HORAS, RECIBIRÁS LAS MEJORES OFERTAS PERSONALIZADAS PARA TU PROYECTO ')
            ...
            <div className="d-sm-flex">
                ...
                <div className="container-fluid acc-to-frac" >
                    <div className="row">
                        ...
                        <div className="col-xl-12 col-lg-12  mx-auto text-center right-side bg-light">
                            {/* col-xlg-9 col-md-9 */}
            ...
            <div className="page-wrapper bg-light" style={{ display: display2 }}>
                ...
                <div id="screens" style={{display:screenDisplay}}>
                {
                    ...
                    data1.map((val,id) => {
                        return(
                            <>
                                <div className="col-md-4 img-box " style={{padding:'5px'}}>
                ...
                <br />
                        ...
                        <div className="w-100 mx-auto ">
                            ...
                            <div className="w-100 my-lg-2"><TextField onChange={(e) => setname(e.target.value)} className="w-50" id="outlined-basic" label="Nombre" variant="outlined" /> </div>
                            <h4 className="text-center w-100 text-dark for-name-sec frank-color-pink">Contacto</h4>
                            <div className="w-100 my-lg-2"><TextField    onChange={(e) => setcontact(e.target.value)} className="w-50" id="outlined-basic" label="Teléfono" variant="outlined" /> </div>
                            <h4 className="text-center w-100 text-dark for-name-sec frank-color-pink">Nombre de empresa</h4>
                            <div className="w-100 my-lg-2"><TextField onChange={(e) => setcompany(e.target.value)} className="w-50" id="outlined-basic" label="Nombre de empresa" variant="outlined" /> </div>
                        ...
                        <div style={{ marginTop: "10px" }}>
                            ...
                            <div className="for-question-res" style={{ display: "flex"}}>
                                ...
                                <div className="w-100">
                                    <input type="radio" name="q1" className="w-25 text-center" onChange={(e) => setsector(e.target.value)} value="Other" />Congreso
                                </div>
                            </div>
                            {/* </p> */}
                            {/* </div> */}
