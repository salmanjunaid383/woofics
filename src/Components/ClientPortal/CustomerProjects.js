                                    ...
                                    <div className="car p-3">
                                        ...
                                        <div className="card-body pb-5">
                                            <div className="border p-5">
                                                ...
                                                {form.status == "Completed" ? <button className="btn pull-right marginBottom10 mx-3" style={{ backgroundColor: 'rgba(7, 72, 138, 0.71)', color: 'white' }} onClick={(e) => history.push(`/feedback/${supplier.id}`)} >Realimentación</button> : <button className="btn pull-right marginBottom10 mx-3" style={{ backgroundColor: 'rgba(7, 72, 138, 0.71)', color: 'white' }} onClick={(e) => Stripe(form.id)} >Marcar Como Completa</button>}
                                                                        ...
                                                                        <div className="col-auto m-1 p-0">
                                                                            <div className="row d-flex align-items-center justify-content-end">
                                                                                <h5 className="m-0 p-0 px-2">
                                                                                    <i className="fa fa-trash-o text-danger btn m-0 px-3" data-toggle="tooltip" data-placement="bottom" title="Delete todo" onClick={() => deleteTodo(val.id)} style={{ cursor: 'pointer', fontSize: 30 }}></i>
                                                                                </h5>
                                                                            </div>
                                                                        </div>
                                                                    </div>
