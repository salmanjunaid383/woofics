                                            ...
                                            <div className="row">
                                                ...
                                                {form == '' ? <h3 className="text-center my-auto mx-auto">Nada Que Mostrar!</h3>
                                                    ...
                                                    form.map((val, id) => {
                                                        return (
                                                            <>
                                                                <div className="col-md-11 py-4  border-bottom mx-auto"> <Link to={`/providercheckresponse/${val.id}`}> Consulta: {val.description}<i className="fas fa-chevron-right float-right"></i></Link></div>
                                                            </>
                                                        )
                                                    })}
                                            </div>
