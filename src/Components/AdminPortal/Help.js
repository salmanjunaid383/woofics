                                        ...
                                        <div className="panel-body">
                                            ...
                                            <form>
                                                <table  id="for-table-setting" className="table">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <button className={`btn btn-sm ${query == '' || answer == '' ? disable : ''}`} onClick={Feedback} style={{ width: '100%', backgroundColor: 'rgba(7, 72, 138, 0.71)', color: 'white' }}><i className="fa fa-envelope-o" style={{ paddingRight: '5px' }}></i> Send</button>
                                                        </td>
                                                    </tr>
                                                </table>
