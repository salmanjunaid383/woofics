                                                        ...
                                                        <li className="contact active" onClick={() => { Users(val.associate_user, val.main_name); setUsername(val.associate_name); setImageProfile(val.avatar) }}>
                                                            <div className="wrap text-left">
                                                                ...
                                                                <div className="meta">
                                                                    ...
                                                                    {val.total_seen != 0 ? <p className="preview pl-md-5 text-danger text-left" style={{ width: '950px' }}>{val.total_seen} Mensajes no leídos...</p> : <p className="preview pl-md-5 text-left " style={{ width: '950px' }}> {val.last_message ? (val.last_message).slice(0, 20) + '...' : null}</p>}
                                                                </div>
                                                            </div>
                                                        </li>
                                                    }
