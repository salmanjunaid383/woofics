                            ...
                            <div className="row border bg-light">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="row">
                                                <div className="form-group mb-4 col-md-6">
                                                    <label className="col-md-6 p-0 bold">Nombre de pila</label>
                                            ...
                                            <div className="row">
                                                <div className="form-group mb-4 row col-md-6">
                                                    <label className="col-md-12 p-0">Tamaño de la Empresa </label>
                                ...
                                <div className="col-lg-4 col-xlg-3 col-md-12">
                                    <div className="py-auto">
                                        <div className="img-fluid pt-5 mt-5 w-50 mx-auto" >
                                ...
                                <div className="col-lg-8 col-xlg-8 col-md-8 mx-auto ">
                                    <div className="">
                                        <div className="card-body">
                                            ...
                                            <div className="row">
                                            <div className="form-group mb-4 col-md-6">
                                                    <label className="col-md-6 p-0 bold">Tarjeta no</label>
                                                ...
                                                <div className="form-group mb-4 col-md-6">
                                                    <label className="col-md-6 p-0 bold">Nombre</label>
                                            ...
                                            <div className="row">
                                            <div className="form-group mb-4 col-md-6">
                                                    <label className="col-md-6 p-0 bold">Meses de Vencimiento</label>
                                                ...
                                                <div className="form-group mb-4 col-md-6">
                                                    <label className="col-md-6 p-0 bold">Año de Caducidad</label>
