...
function Navbar() {
  ...
  function LoginBtn(e) {
    ...
    if (email === "" || password === "") {
      ...
      setWait("Please wait...");
      const { data: response } = axios
        .post(`https://api.woofics.com/api/login`, {
          email: email,
          password: password,
        })
        .then(
  ...
  const responseGoogle = (respons) => {
    const res = axios
      .post(`https://api.woofics.com/api/google`, {
  ...
  const responseFacebook = (response) => {
    const res = axios
      .post(`https://api.woofics.com/api/facebook`, {
      ...
      <div className="container.fluid ">
        <div className="woofic_background  my-auto ">
          <div
            className={
              navState
                ? "topnav topnavresponsive pb-1 pt-1 fixed-top "
                : landingPage
                ? "topnav pb-1 pt-1 fixed-top"
                : "topnav pb-1 pt-1 fixed-top nonLandingPageNav"
            }
            id="myTopnav"
            style={{ height: "65px" }}
          >
            ...
            <Link
              ...
              className="pt-3 taglink for-res"
              id=""
            >
              Foro
            </Link>
            ...
            <Link
              to="/cita_principal"
              className="pt-3 taglink hover-effect for-res"
              id=""
            >
              Oferta
            </Link>
            ...
            <Link
              id="scroll-effect"
              className="for-res"
              style={{ marginLeft: "-12px", marginTop: "1px" }}
            >
              {/* Advertise */}

              <div className="dropdown hover-effect">
                <button
                  className={navState ? "dropbtn dropbtnresponse" : "dropbtn"}
                  id="dropDownLink"
                >
                  Instrumentos
                </button>
              ...
              <div className="dropdown hover-effect">
                ...
                <div className="dropdown-content">
                  <Typography className={classes.typography}>
                    <Link
                      className="profile-pic pt-3 text-blackStaz"
                      to={profileLink}
                      id="text-blackStaz"
                    >
                      <i className="fa fa-user mx-3 text-blackStaz"></i>
                      <span className="text-black font-medium mr-3 text-blackStaz">
                        Perfil
                      </span>
                    </Link>
                  </Typography>
            ...
            {localStorage.getItem("user_token") ? (
              <>
                <a
                  className="profile-pic float-right text-blackStaz"
                  style={{ marginRight: "20px" }}
                  aria-describedby={idStaz}
                  variant="contained"
                  color="primary"
                  onClick={handleClickStaz}
                >
                  <span className="text-white font-medium ">
                    <img
                      className="img-fluid mb-2 pro-pic"
                      src={
                        profile_image !== null
                          ? profile_image
                          : profileImageStaz
                  ...
                  <div className="col-md-7 col-lg-7 col-sm-12  pr-lg-5 my-auto ">
                    <div className=" py-3 px-4">
                      ...
                      <div className="mb-4 mt-2 text-center">
                        <button
                          type="submit"
                          className={`btn btn-blue w-100 shadow py-2 ${
              ...
              <div className="container bg-white rounded ">
                <div className="row">
                  <div className="col-md-12 col-lg-6 col-sm-12 p-0 m-0 d-none d-lg-block mx-auto p-5">
                    ...
                    >
                      <b>
                        Accede a la mayor comunidad de soluciones LED de Europa
                      </b>
                    </h3>
                    <h5 className=" py-3 h5 text-muted">
                      ¡Pasa Al Siguiente Nivel,Obten las mejores ofertas de
                      provedores certificados y todo desde un mismo lugar!
                    </h5>
