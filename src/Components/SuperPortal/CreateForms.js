                    ...
                    <div className="page-wrapper bg-light">
                        <div className="container-fluid">
                            <div className="d-md-flex mb-3">
                                <h3 className=" mb-0 mx-auto text-center text-change">CARGOS</h3>
                            </div> 
                            <div className="row">
                                ...
                                <div className="col-lg-8 col-xlg-9 col-md-12 mx-auto">
                                    <div className="card">
                                        <div className="card-body">
                                            {ford === "supplier" ? <div className="form-horizontal form-material" style={{ textAlign: 'left' }}>
                                                ...
                                                <div className="row mt-5">
                                                    ...
                                                    <div className="mb-4 mt-4 text-center mx-auto">
                                                        <div className="col-sm-12 text-center">
                                                            <button className={`btn text-white mt-3 greenbtn text-white `}  onClick={() => paymentPack()}>Agregar</button>
                                                        </div>
                                                    </div>
                                                    <table  id="for-table-setting" className="table table-hover mt-2 text-center">
                                                            ...
                                                            {paymentPackag.map((val, i) => {
                                                                return (<>
                                                                    <tr>
                                                                        ...
                                                                        <td>{val.start}</td>
                                                                        <td>{val.end}</td>
                                                                        <td><button className={`btn btn-danger text-white`} onClick={() => paymentPackDel(val.id)}>Borrar </button></td>
                                                                    </tr>
                                                                </>)
                                                            })
                                                            }
                                            ...
                                            </div> : ford === "value" ? <div className="form-horizontal form-material" style={{ textAlign: 'left' }}>
                                                <div className="row mt-4 text-center">
                                                    <div className="col-md-6 text-center mx-auto px-2 w-100 p-0" style={{ display: check === 'true' ? 'block' : 'none' }}>
                                                        ...
                                                        <div className="col-sm-12 text-center" style={{paddingBottom:'5px'}}>
                                                            <button className={`btn text-white mt-2 greenbtn text-white `}  onClick={() => valCharge()}>Agregar</button>
                                                        </div>
                                                    </div>
                                                    <div className="col-md-12 text-center mx-auto px-2 w-100 p-0">
                                                        <table  id="for-table-setting" className="table table-hover" style={{tableLayout:"fixed"}}>
                                                            <thead id="heading-row"className="py-3" style={{ backgroundColor: "#f25c8a", borderRadius: 10 }}>
                                                            ...
                                                            <tbody id="data-row">
                                                                <tr>
                                                                    ...
                                                                    <td><button className={`btn text-white mr-2 greenbtn text-white `}  onClick={() => setcheck('true')}>Editar</button></td>
                                                ...
                                                ford === "rental" ?
                                                    ...
                                                    <div className="form-horizontal form-material" style={{ textAlign: 'left' }}>
                                                        <div className="row mt-4 mx-auto">
                                                            ...
                                                            <div className="col-md-12 mb-4 mt-4 w-100 text-center mx-auto" style={{ display: check2 === 'true' ? 'block' : 'none' }}>
                                                                <div className="col-sm-12 text-center">
                                                                    <button className={`btn text-white greenbtn text-white `}  onClick={() => supplierRental()}>Agregar</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="col-md-12 text-center mx-auto px-2 w-100 p-0">
                                                            <table  id="for-table-setting" className="table table-hover" style={{tableLayout:"fixed"}}>
                                                                ...
                                                                <tbody id="data-row">
                                                                    <tr>
                                                                        ...
                                                                        <td><button className={`btn text-white mr-2 greenbtn text-white `}  onClick={() => setcheck2('true')}>Editar</button></td> 
                                                    ...
                                                    <div className="form-horizontal form-material" style={{ textAlign: 'left' }}>
                                                        ...
                                                        <div className=" col-md-12 mb-4 mt-4 w-100 text-center mx-auto " style={{ display: check3 === 'true' ? 'block' : 'none' }}>
                                                            <div className="col-sm-12 text-center">
                                                                <button className={`btn text-white greenbtn text-white `}  onClick={serviceCharges}>Agregar</button>
                                                            </div>
                                                        </div>
                                                        <div className="col-md-12 text-center mx-auto px-2 w-100 p-0">
                                                            <table  id="for-table-setting" className="table table-hover" style={{tableLayout:"fixed"}}>
                                                                ...
                                                                <tbody id="data-row">
                                                                    <tr>
                                                                        ...
                                                                        <td><button className={`btn text-white mr-2 greenbtn text-white `}  onClick={() => setcheck3('true')}>Editar</button></td>
