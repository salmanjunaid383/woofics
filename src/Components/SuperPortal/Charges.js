                    ...
                    <div className="page-wrapper bg-light">
                        <div className="container pb-lg-4">
                            <div className="row m-lg-5 text-center mx-auto my-auto">
                                <div className="col-md-5 m-3 p-5 mx-auto text-center shadow border rounded" style={{ cursor: 'pointer' }} onClick={() => history.push('/crear_formas/value')}>
                                    <i className="fa fa-5x py-3 fa-money " style={{ color: "#f25c8a" }}></i>
                                    <h5 className="h5">Cargo Por Valor</h5>
                                </div>
                                <div className="col-md-5 m-3 p-5 mx-auto text-center shadow border rounded" style={{ cursor: 'pointer' }} onClick={() => history.push('/crear_formas/supplier')}>
                                    <i className="fa fa-5x py-3 fa-cubes " style={{ color: "#9b88f6" }}></i>
                                    <h5 className="h5">Paquetes De Proveedores</h5>
                                </div>
                                <div className="col-md-5 m-3 p-5 mx-auto text-center shadow border rounded" style={{ cursor: 'pointer' }} onClick={() => history.push('/crear_formas/rental')}>
                                    <i className="fas fa-5x py-3 fa-truck-loading " style={{ color: "#9b88f6" }}></i>
                                    <h5 className="h5">Cargos Por Alquiler De Proveedores</h5>
                                </div>
                                <div className="col-md-5 m-3 p-5 mx-auto text-center shadow border rounded" style={{ cursor: 'pointer' }} onClick={() => history.push('/crear_formas/service')}>
