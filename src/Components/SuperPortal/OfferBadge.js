...
export default function OfferBadge() {
  ...
  function getReg() {
    const { data: response } = axios
      .get(`https://api.woofics.com/api/offer`, {
  ...
  function deleteAdv(e) {
    ...
    if (result) {
      const { data: response } = axios
        .put(`https://api.woofics.com/api/offer/${e}`, {
          headers: window.header,
        })
        .then(
          (response) => {
              ...
              <div className="row m-lg-5">
                <div className="col-md-12 col-lg-12 col-sm-12">
                  <div className="white-box">
                    <h3
                      class=" mb-0 h1 text-center mx-auto text-change"
                      style={{
                        fontSize: "36px",
                        fontWeight: "500",
                        marginTop: "15px",
                      ...
                      {blog
                        .map((val, key) => {
                          return (
                            <>
                              <div
                                class="col-xl-12 col-md-12 mx-auto shadow p-3 mb-3 "
                                style={{
                                  backgroundColor: "white",
                                  border: "3px #f95c87 solid",
                                  borderRadius: 10,
                                }}
                              >
                                <div className="row">
                                  ...
                                  <div className="col-md-5">
                                    ...
                                    />
                                    <p>
                                      <i className="fa fa-phone pr-2 pt-2 "></i>
                                      {val.contact_number}
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                      <i className="fa fa-question pr-2 "></i>
                                      {val.service}
                                    </p>
                                  </div>
                                ...
                                <div className="row py-3 px-2">
                                  <span className="ml-auto">
                                    <div className="p-2 border-danger bg-light text-dark mx-3">
                                      {val.locked === 0
                                        ? "Approved"
                                        : "Not approved"}{" "}
                                      <i
